...
| 第 2 轮修订 | 2026-08-25：按《doc/review-report-round1.md》§2 实证事实 E2-E5 对齐真实 DSH 0.1.1-rc.2 `ctx.subagents` API 契约（F-05、§4.9.3 能力模型、§5 安全/非交互模式、§7.1 第 5 项） |
...
- `doc/架构设计文档.md` v0.2.0（2026-08-24）
- ADR-030 ~ ADR-033
- 附录 A 版本演进摘要
