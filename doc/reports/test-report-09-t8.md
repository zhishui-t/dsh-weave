...
pnpm exec playwright test \
  e2e/features/graph-positive.spec.ts \
  e2e/features/graph-negative.spec.ts \
  e2e/features/knowledge-graph.spec.ts \
  e2e/features/obsidian.spec.ts \
  e2e/features/document-convert.spec.ts \
  e2e/features/console-pages.spec.ts
```
