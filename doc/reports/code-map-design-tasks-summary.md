...
> 产物：`doc/design/05-反思沉淀与技能落地-优化设计文档.md` 新增 **§8 代码调用链图谱设计**（含 §8.6 实施任务清单 T59–T65）
...
- 改动：仅 `doc/design/05-反思沉淀与技能落地-优化设计文档.md`（头部修订记录 + 新增 §8 全节，插于 §7 与附录 A 之间）；另新增本摘要 `output/code-map-design-tasks-summary.md`。
